...
if __name__ == "__main__":
    test_local_codex_sources_include_archived_sessions()
    test_remote_cache_age_ignores_empty_archived_dir()
    test_codex_parser_default_includes_archived_sibling()
    test_load_all_local_dedups_data_live_and_archived_sources()
    print("PASS: local Codex sources include archived_sessions")
